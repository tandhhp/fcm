        ...
        try
        {
            ...
            var query = from l in _context.Leads
                        ...
                        select new
                        {
                            ...
                            SalesAvatar = sales.Avatar,
                            TelesalesName = telesales.Name,
                            TelesalesAvatar = telesales.Avatar,
                            l.SourceId,
                            SourceName = s.Name,
                            l.EventId,
                            EventName = e.Name,
                            ...
                            TeamSales = c.SmId != null ? _context.Users.First(u => u.Id == c.ManagerId).Name : null,
                            TeamTelesales = c.TmId != null ? _context.Users.First(u => u.Id == c.ManagerId).Name : null,
